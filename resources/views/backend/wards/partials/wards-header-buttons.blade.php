<!--Action Button-->
@if( Active::checkUriPattern( 'admin/wards' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.wards.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.wards.all' ) }}
            </a>
        </li>
        @permission( 'create-ward' )
            <li>
                <a href="{{ route( 'admin.wards.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.wards.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
