        ...
        <ul class="navbar-nav my-lg-0">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark"
               href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false"><img src="images/1.jpg"
                                                               alt="user" class="img-circle" width="30"></a>
            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
              <span class="with-arrow"><span class="bg-primary"></span></span>
              <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                <div class=""><img src="images/1.jpg" alt="user" class="img-circle"
                                   width="60"></div>
                <div class="m-l-10">
        ...
        <ul id="sidebarnav">
          <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              ...
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/index2.html">Analytical</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/index3.html">Demographical</a>
              </li>
              <li><a
                  href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/index4.html">Modern</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/index5.html">Cryptocurrency</a>
              </li>
            </ul>
          </li>
          <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/app-calendar.html">Calendar</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/app-chat.html">Chat
                app</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/app-ticket.html">Support
                Ticket</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/app-contact.html">Contact
                / Employee</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/app-contact2.html">Contact
                Grid</a></li>
              <li><a
              ...
              <li><a href="javascript:void(0)" class="has-arrow">Inbox</a>
                <ul aria-expanded="false" class="collapse">
                  <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/app-email.html">Mailbox</a>
                  </li>
                  <li><a
          ...
          <li><a class="has-arrow waves-effect waves-dark two-column" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              ...
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-user-card.html">User
                Cards</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-buttons.html">Buttons</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-modals.html">Modals</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-tab.html">Tab</a>
              </li>
              <li><a
              ...
              <li><a
                ...
                stylish</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-sweetalert.html">Sweet
                Alert</a></li>
              <li><a
              ...
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-nestable.html">Nestable</a>
              </li>
              <li><a
                  href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-range-slider.html">Range
                slider</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-timeline.html">Timeline</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-typography.html">Typography</a>
              </li>
              <li><a
              ...
              <li><a
                ...
                Ideal Timeout</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-bootstrap.html">Bootstrap
                Ui</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-breadcrumb.html">Breadcrumb</a>
              </li>
              <li><a
                  href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-bootstrap-switch.html">Bootstrap
                Switch</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-list-media.html">List
                Media</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-ribbons.html">Ribbons</a>
              </li>
              <li><a
                  href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-grid.html">Grid</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-carousel.html">Carousel</a>
              </li>
              <li><a
              ...
              <li><a
                ...
                Portlet</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-spinner.html">Spinner</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-scrollspy.html">Scrollspy</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/ui-toasts.html">Toasts</a>
              </li>
            </ul>
          </li>
          ...
          <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-basic.html">Basic
                Forms</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-layout.html">Form
                Layouts</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-addons.html">Form
                Addons</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-material.html">Form
                Material</a></li>
              <li><a
                  href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-float-input.html">Floating
                Lable</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-pickers.html">Form
                Pickers</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-upload.html">File
                Upload</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-mask.html">Form
                Mask</a></li>
              <li><a
              ...
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-dropzone.html">File
                Dropzone</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-icheck.html">Icheck
                control</a></li>
              <li><a
              ...
              <li><a
                ...
                Editor</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-typehead.html">Form
                Typehead</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-wizard.html">Form
                Wizard</a></li>
              <li><a
              ...
              <li><a
                ...
                Editor</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/form-tinymce.html">Tinymce
                Editor</a></li>
            </ul>
          </li>
          <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/table-basic.html">Basic
                Tables</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/table-layout.html">Table
                Layouts</a></li>
              <li><a
              ...
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/table-jsgrid.html">Js
                Grid Table</a></li>
              <li><a
          ...
          <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/widget-data.html">Data
                Widgets</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/widget-apps.html">Apps
                Widgets</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/widget-charts.html">Charts
                Widgets</a></li>
            </ul>
          </li>
          <li class="nav-small-cap"></li>
          <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
            ...
            <ul aria-expanded="false" class="collapse">
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/starter-kit.html">Starter
                Kit</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-blank.html">Blank
                page</a></li>
              ...
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-profile.html">Profile
                page</a></li>
              <li><a
              ...
              <li><a
                ...
                Right sidebar</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-invoice.html">Invoice</a>
              </li>
              <li><a
              ...
              <li><a
                ...
                result</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-scroll.html">Scrollbar</a>
              </li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-pricing.html">Pricing</a>
              </li>
              <li><a
                  href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-lightbox-popup.html">Lighbox
                popup</a></li>
              <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/pages-gallery.html">Gallery</a>
              </li>
              <li><a
              ...
              <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><span
                ...
                <ul aria-expanded="false" class="collapse">
                  ...
                  <li><a
                    ...
                    Line icons</a></li>
                  <li><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/icon-flag.html">Flag
                    Icons</a></li>
                </ul>
              </li>
              <li><a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><span
      ...
      <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
          <div class="d-flex justify-content-end align-items-center">
            ...
            <button type="button" class="btn btn-success d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i>
              Create New
            </button>
          </div>
        </div>
      ...
      <div class="card-group">
        ...
        <div class="card o-income">
          <div class="card-body">
            ...
            <div id="income" style="height: 260px; width: 100%; max-height: 290px; position: relative;" class="c3">
              <svg width="580" height="290" style="overflow: hidden;">
                ...
                <g transform="translate(40.5,4.5)">
                  <text class="c3-text c3-empty" text-anchor="middle" dominant-baseline="middle" x="269" y="118"
                  ...
                  <g clip-path="url(https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#c3-1597806936501-clip-grid)"
                    ...
                    <g class="c3-xgrid-focus">
                      <line class="c3-xgrid-focus" x1="269" x2="269" y1="0" y2="236" style="visibility: hidden;"></line>
                    </g>
                  </g>
                  <g clip-path="url(https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#c3-1597806936501-clip)"
                     class="c3-chart">
                    <g class="c3-event-rects c3-event-rects-single" style="fill-opacity: 0;">
                      <rect class=" c3-event-rect c3-event-rect-0" x="0.20000000000000284" y="0" width="107.6"
                            height="236"></rect>
                      <rect class=" c3-event-rect c3-event-rect-1" x="108.2" y="0" width="107.6" height="236"></rect>
                      <rect class=" c3-event-rect c3-event-rect-2" x="215.2" y="0" width="107.6" height="236"></rect>
                      <rect class=" c3-event-rect c3-event-rect-3" x="323.2" y="0" width="107.6" height="236"></rect>
                      <rect class=" c3-event-rect c3-event-rect-4" x="431.2" y="0" width="107.6" height="236"></rect>
                    </g>
                    <g class="c3-chart-bars">
                      ...
                      <g class="c3-chart-bar c3-target c3-target-Net-Income" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-shapes c3-shapes-Net-Income c3-bars c3-bars-Net-Income" style="cursor: pointer;">
                          <path class="c3-shape c3-shape-0 c3-bar c3-bar-0"
                    ...
                    <g class="c3-chart-lines">
                      ...
                      <g class="c3-chart-line c3-target c3-target-Net-Income" style="opacity: 1; pointer-events: none;">
                    ...
                    <g class="c3-chart-texts">
                      ...
                      <g class="c3-chart-text c3-target c3-target-Net-Income" style="opacity: 1; pointer-events: none;">
                  ...
                  <g class="c3-axis c3-axis-x"
                    ...
                    <text class="c3-axis-x-label" transform="" style="text-anchor: end;" x="538" dx="-0.5em"
                          dy="-0.5em"></text>
                  ...
                  <g class="c3-axis c3-axis-y"
                    ...
                    <text class="c3-axis-y-label" transform="rotate(-90)" style="text-anchor: end;" x="0" dx="-0.5em"
                          dy="1.2em"></text>
                  ...
                  <g class="c3-axis c3-axis-y2" transform="translate(538,0)" style="visibility: hidden; opacity: 1;">
                    <text class="c3-axis-y2-label" transform="rotate(-90)" style="text-anchor: end;" x="0" dx="-0.5em"
                          dy="-0.5em"></text>
                    <g class="tick" transform="translate(0,236)" style="opacity: 1;">
                      <line x2="6" y2="0"></line>
                ...
                <g transform="translate(20.5,290.5)" style="visibility: hidden;">
                  ...
                  <g clip-path="url(https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#c3-1597806936501-clip)"
                     class="c3-brush" style="pointer-events: all; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                    <rect class="background" x="0" width="558" style="visibility: hidden; cursor: crosshair;"></rect>
                ...
                <g transform="translate(0,270)">
                  <g class="c3-legend-item c3-legend-item-Growth-Income" style="visibility: hidden; cursor: pointer;">
                  ...
                  <g class="c3-legend-item c3-legend-item-Net-Income" style="visibility: hidden; cursor: pointer;">
              ...
              <div class="c3-tooltip-container"
                ...
                <table class="c3-tooltip">
                  ...
                  <tr class="c3-tooltip-name--Growth-Income">
                    <td class="name"><span style="background-color:#7460ee"></span>Growth Income</td>
            ...
            <div id="visitor" style="height: 260px; width: 100%; max-height: 260px; position: relative;" class="c3">
              <svg width="580" height="260" style="overflow: hidden;">
                ...
                <g transform="translate(0.5,4.5)">
                  <text class="c3-text c3-empty" text-anchor="middle" dominant-baseline="middle" x="290" y="118"
                        style="opacity: 0;"></text>
                  ...
                  <g clip-path="url(https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#c3-1597806936400-clip-grid)"
                    ...
                    <g class="c3-xgrid-focus">
                      <line class="c3-xgrid-focus" x1="-10" x2="-10" y1="0" y2="236" style="visibility: hidden;"></line>
                    </g>
                  </g>
                  <g clip-path="url(https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#c3-1597806936400-clip)"
                     class="c3-chart">
                    <g class="c3-event-rects c3-event-rects-single" style="fill-opacity: 0;">
                      <rect class=" c3-event-rect c3-event-rect-0" x="0" y="0" width="580" height="236"></rect>
                    </g>
                    <g class="c3-chart-bars">
                      <g class="c3-chart-bar c3-target c3-target-Other" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-shapes c3-shapes-Other c3-bars c3-bars-Other" style="cursor: pointer;"></g>
                      </g>
                      <g class="c3-chart-bar c3-target c3-target-Desktop" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-shapes c3-shapes-Desktop c3-bars c3-bars-Desktop" style="cursor: pointer;"></g>
                      </g>
                      <g class="c3-chart-bar c3-target c3-target-Tablet" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-shapes c3-shapes-Tablet c3-bars c3-bars-Tablet" style="cursor: pointer;"></g>
                      </g>
                      <g class="c3-chart-bar c3-target c3-target-Mobile" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-shapes c3-shapes-Mobile c3-bars c3-bars-Mobile" style="cursor: pointer;"></g>
                      </g>
                    </g>
                    <g class="c3-chart-lines">
                      <g class="c3-chart-line c3-target c3-target-Other" style="opacity: 1; pointer-events: none;">
                        ...
                        <g class=" c3-shapes c3-shapes-Other c3-circles c3-circles-Other" style="cursor: pointer;"></g>
                      </g>
                      <g class="c3-chart-line c3-target c3-target-Desktop" style="opacity: 1; pointer-events: none;">
                      ...
                      <g class="c3-chart-line c3-target c3-target-Tablet" style="opacity: 1; pointer-events: none;">
                      ...
                      <g class="c3-chart-line c3-target c3-target-Mobile" style="opacity: 1; pointer-events: none;">
                    ...
                    <g class="c3-chart-arcs" transform="translate(290,113)">
                      <text class="c3-chart-arcs-title" style="text-anchor: middle; opacity: 1;">Visits</text>
                      <g class="c3-chart-arc c3-target c3-target-Other">
                        ...
                        <text dy=".35em" class="" transform="translate(-80.29919492182343,-30.453467699212958)"
                      ...
                      <g class="c3-chart-arc c3-target c3-target-Desktop">
                        ...
                        <text dy=".35em" class="" transform="translate(-20.552429249015532,-83.38448328054933)"
                              style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                      </g>
                      <g class="c3-chart-arc c3-target c3-target-Tablet">
                        ...
                        <text dy=".35em" class="" transform="translate(-20.552429249015436,83.38448328054935)"
                              style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                      </g>
                      <g class="c3-chart-arc c3-target c3-target-Mobile">
                        ...
                        <text dy=".35em" class="" transform="translate(80.29919492182341,-30.45346769921297)"
                              style="opacity: 1; text-anchor: middle; pointer-events: none;"></text>
                      </g>
                    </g>
                    <g class="c3-chart-texts">
                      <g class="c3-chart-text c3-target c3-target-Other" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-texts c3-texts-Other"></g>
                      </g>
                      <g class="c3-chart-text c3-target c3-target-Desktop" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-texts c3-texts-Desktop"></g>
                      </g>
                      <g class="c3-chart-text c3-target c3-target-Tablet" style="opacity: 1; pointer-events: none;">
                        <g class=" c3-texts c3-texts-Tablet"></g>
                      </g>
                      <g class="c3-chart-text c3-target c3-target-Mobile" style="opacity: 1; pointer-events: none;">
                  ...
                  <g class="c3-axis c3-axis-x"
                    ...
                    <text class="c3-axis-x-label" transform="" style="text-anchor: end;" x="580" dx="-0.5em"
                          dy="-0.5em"></text>
                  ...
                  <g class="c3-axis c3-axis-y2" transform="translate(580,0)" style="visibility: hidden; opacity: 0;">
                    <text class="c3-axis-y2-label" transform="rotate(-90)" style="text-anchor: end;" x="0" dx="-0.5em"
                          dy="-0.5em"></text>
                    <g class="tick" transform="translate(0,236)" style="opacity: 1;">
                      <line x2="6" y2="0"></line>
                ...
                <g transform="translate(0.5,260.5)" style="visibility: hidden;">
                  ...
                  <g clip-path="url(https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#c3-1597806936400-clip)"
                     class="c3-brush" style="pointer-events: all; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                    <rect class="background" x="0" width="580" style="visibility: hidden; cursor: crosshair;"></rect>
                    <rect class="extent" x="0" width="0" style="cursor: move;"></rect>
                    <g class="resize e" transform="translate(0,0)" style="cursor: ew-resize; display: none;">
                      <rect x="-3" width="6" height="6" style="visibility: hidden;"></rect>
                    </g>
                ...
                <g transform="translate(0,240)">
                  <g class="c3-legend-item c3-legend-item-Other" style="visibility: hidden; cursor: pointer;">
                  ...
                  <g class="c3-legend-item c3-legend-item-Desktop" style="visibility: hidden; cursor: pointer;">
                  ...
                  <g class="c3-legend-item c3-legend-item-Tablet" style="visibility: hidden; cursor: pointer;">
                  ...
                  <g class="c3-legend-item c3-legend-item-Mobile" style="visibility: hidden; cursor: pointer;">
            ...
            <div class="card-body">
              ...
              <div id="morris-area-chart"
                ...
                <svg height="350" version="1.1" width="1195.33" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <text x="32.859375" y="311" text-anchor="end" font-family="sans-serif" font-size="12px" stroke="none"
                        fill="#888888"
                  ...
                  <text x="32.859375" y="239.5" text-anchor="end" font-family="sans-serif" font-size="12px"
                  ...
                  <path fill="none" stroke="#f6f6f6" d="M45.359375,239.5H1170.33" stroke-width="0.5"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                  <text x="32.859375" y="168" text-anchor="end" font-family="sans-serif" font-size="12px" stroke="none"
                        fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: end; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal">
                  ...
                  <path fill="none" stroke="#f6f6f6" d="M45.359375,168H1170.33" stroke-width="0.5"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                  <text x="32.859375" y="96.5" text-anchor="end" font-family="sans-serif" font-size="12px" stroke="none"
                        fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: end; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal">
                  ...
                  <path fill="none" stroke="#f6f6f6" d="M45.359375,96.5H1170.33" stroke-width="0.5"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                  <text x="32.859375" y="25" text-anchor="end" font-family="sans-serif" font-size="12px" stroke="none"
                        fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: end; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal">
                  ...
                  <path fill="none" stroke="#f6f6f6" d="M45.359375,25H1170.33" stroke-width="0.5"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                  <text x="1170.33" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                  ...
                  <text x="982.9204709607484" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal" transform="matrix(1,0,0,1,0,7)">
                    <tspan dy="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">2015</tspan>
                  </text>
                  <text x="795.510941921497" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal" transform="matrix(1,0,0,1,0,7)">
                    <tspan dy="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">2014</tspan>
                  </text>
                  <text x="608.1014128822455" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal" transform="matrix(1,0,0,1,0,7)">
                    <tspan dy="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">2013</tspan>
                  </text>
                  <text x="420.1784330785029" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal" transform="matrix(1,0,0,1,0,7)">
                    <tspan dy="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">2012</tspan>
                  </text>
                  <text x="232.76890403925145" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal" transform="matrix(1,0,0,1,0,7)">
                    <tspan dy="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">2011</tspan>
                  </text>
                  <text x="45.359375" y="323.5" text-anchor="middle" font-family="sans-serif" font-size="12px"
                        stroke="none" fill="#888888"
                        style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: sans-serif; font-size: 12px; font-weight: normal;"
                        font-weight="normal" transform="matrix(1,0,0,1,0,7)">
                  ...
                  <path fill="#39aff5" stroke="none"
                        ...
                        fill-opacity="0" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); fill-opacity: 0;"></path>
                  ...
                  <circle cx="45.359375" cy="311" r="0" fill="#009efb" stroke="#f62d51" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="232.76890403925145" cy="187.06666666666666" r="0" fill="#009efb" stroke="#f62d51"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="420.1784330785029" cy="234.73333333333335" r="0" fill="#009efb" stroke="#f62d51"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="608.1014128822455" cy="244.26666666666665" r="0" fill="#009efb" stroke="#f62d51"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="795.510941921497" cy="139.4" r="0" fill="#009efb" stroke="#f62d51" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="982.9204709607484" cy="210.89999999999998" r="0" fill="#009efb" stroke="#f62d51"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="1170.33" cy="72.66666666666666" r="0" fill="#009efb" stroke="#f62d51" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  ...
                  <path fill="none" stroke="#7460ee"
                        ...
                        stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                  <circle cx="45.359375" cy="311" r="0" fill="#7460ee" stroke="#7460ee" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="232.76890403925145" cy="215.66666666666666" r="0" fill="#7460ee" stroke="#7460ee"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="420.1784330785029" cy="253.8" r="0" fill="#7460ee" stroke="#7460ee" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="608.1014128822455" cy="120.33333333333331" r="0" fill="#7460ee" stroke="#7460ee"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="795.510941921497" cy="168" r="0" fill="#7460ee" stroke="#7460ee" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="982.9204709607484" cy="215.66666666666666" r="0" fill="#7460ee" stroke="#7460ee"
                          stroke-width="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                  <circle cx="1170.33" cy="168" r="0" fill="#7460ee" stroke="#7460ee" stroke-width="1"
                          style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
                </svg>
                <div class="morris-hover morris-default-style" style="left: 2.85938px; top: 208px; display: none;">
              ...
              <div class="steamline m-t-40">
                ...
                <div class="sl-item">
                  <div class="sl-left"><img class="img-circle" alt="user"
                                            src="js/3.jpg"></div>
                  <div class="sl-right">
                    <div><a href="https://www.wrappixel.com/demos/admin-templates/elegant-admin/horizontal/#">Tiger
                    ...
                    <div class="desc">Approve meeting with tiger
                      <br><a href="javascript:void(0)"
                          ...
                          href="javascript:void(0)" class="btn m-t-10 btn-rounded btn-outline-danger">Refuse</a></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="carousel-inner">
                <div class="carousel-item">
                  <div class="carousel-caption">
                    ...
                    <p class="op-5">It has survived not only five centuries, but also the leap into electronic
                      typesetting</p>
                    <div class="row">
                ...
                <div class="carousel-item active">
                  <div class="carousel-caption">
                    ...
                    <h4 class="m-t-10">It has survived not only five centuries, but also the leap into electronic
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex no-block align-items-center">
                ...
                <div class="ml-auto">
                  <button class="float-right btn btn-circle btn-success" data-toggle="modal" data-target="#myModal"><i
                ...
                <div class="message-widget message-scroll">
                  ...
                  <a href="javascript:void(0)">
                    <div class="user-img"><img src="js/2.jpg" alt="user"
                                               class="img-circle"> <span class="profile-status busy float-right"></span>
                    </div>
                    <div class="mail-contnet">
                ...
                <ul class="chat-list">
                  ...
                  <li>
                    ...
                    <div class="chat-content">
                      ...
                      <div class="box bg-light-info">Lorem Ipsum is simply dummy text of the printing &amp; type setting
                        industry.
                      </div>
                    </div>
            ...
            <div class="card-body border-top">
              <div class="row">
                ...
                <div class="col-4 text-right">
                  <button type="button" class="btn btn-info btn-circle btn-lg"><i class="fas fa-paper-plane"></i>
                  </button>
                </div>
              </div>
            </div>
