<!--Action Button-->
@if( Active::checkUriPattern( 'admin/provinces' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.provinces.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.provinces.all' ) }}
            </a>
        </li>
        @permission( 'create-province' )
            <li>
                <a href="{{ route( 'admin.provinces.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.provinces.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
