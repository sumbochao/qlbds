<!--Action Button-->
@if( Active::checkUriPattern( 'admin/districts' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.districts.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.districts.all' ) }}
            </a>
        </li>
        @permission( 'create-district' )
            <li>
                <a href="{{ route( 'admin.districts.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.districts.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
